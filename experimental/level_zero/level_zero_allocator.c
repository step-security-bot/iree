...
static iree_status_t iree_hal_level_zero_allocator_query_memory_heaps(
    iree_hal_allocator_t* IREE_RESTRICT base_allocator,
...
iree_hal_level_zero_allocator_query_buffer_compatibility(
    iree_hal_allocator_t* IREE_RESTRICT base_allocator,
...
static iree_status_t iree_hal_level_zero_allocator_allocate_buffer(
  ...
  if (iree_status_is_ok(status)) {
    ...
    *out_buffer = buffer;
    ...
    if (!buffer) {
      iree_hal_level_zero_buffer_free(allocator->context, compat_params.type,
                                      device_ptr, host_ptr);
    } else {
...
static const iree_hal_allocator_vtable_t iree_hal_level_zero_allocator_vtable =
    {
        ...
        .query_memory_heaps = iree_hal_level_zero_allocator_query_memory_heaps,
