...
BERT_LARGE_FP32_URL = string.Template(
    "https://storage.googleapis.com/iree-model-artifacts/pytorch/pt_models_20230925.972_1695729217/BERT_LARGE_FP32_PT_384XI32_BATCH${batch_size}/linalg.mlirbc"
)
...
RESNET50_FP32_URL = string.Template(
    "https://storage.googleapis.com/iree-model-artifacts/pytorch/pt_models_20230925.972_1695729217/RESNET50_FP32_PT_3X224X224XF32_BATCH${batch_size}/linalg.mlirbc"
)
