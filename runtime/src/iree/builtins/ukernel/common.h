...
// * GCC >= 12 on x86-64
// Not worth doing per-architecture switches here, so we just test for the
// compiler version that makes it work everywhere.
#if IREE_UK_COMPILER_CLANG_VERSION_AT_LEAST(15, 0) || \
